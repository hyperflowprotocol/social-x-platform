...
class HyperEVMContractDeployer:
    ...
    def _deploy_real_contract(self, account_handle, creator_address, initial_supply, creator_allocation):
        ...
        try:
            ...
            # Check if we have deployer private key
            deployer_key = os.environ.get('DEPLOYER_PRIVATE_KEY')
            if not deployer_key:
                print("⚠️ DEPLOYER_PRIVATE_KEY not provided - using existing contract method")
            ...
            print("🚀 Attempting REAL blockchain deployment...")
            return self._deploy_with_ethers(account_handle, creator_address, initial_supply, creator_allocation, deployer_key)
        except Exception as e:
    ...
    def _deploy_with_ethers(self, account_handle, creator_address, initial_supply, creator_allocation, deployer_key):
        """Deploy contract using simplified ethers.js approach"""
        try:
            import subprocess
            import tempfile
            import os
