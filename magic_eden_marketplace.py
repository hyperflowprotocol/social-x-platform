...
<text x="150" y="160" fill="#475569" text-anchor="middle" dominant-baseline="middle" font-size="12">HyperEVM Asset</text>
        ...
        // Add working showCreateNFT function
        window.showCreateNFT = function() {
            console.log('🎨 NFT Creator opened!');
            document.getElementById('main-content').innerHTML = `
                <div style="min-height: 100vh; padding: 20px; text-align: center;">
                    <h1 style="color: white; font-size: 48px; margin-bottom: 20px;">🚀 NFT Collection Creator</h1>
                    <div style="background: rgba(30, 41, 59, 0.4); border-radius: 20px; padding: 40px; max-width: 600px; margin: 0 auto;">
                        <div style="font-size: 72px; margin-bottom: 20px;">🎨</div>
                        <h2 style="color: #2dd4bf; margin-bottom: 20px;">Magic Eden Launchpad Ready!</h2>
                        ...
                        <button onclick="showPage('home')" 
                            style="background: linear-gradient(135deg, #2dd4bf, #06b6d4); border: none; border-radius: 12px; padding: 20px 40px; color: white; font-size: 18px; font-weight: 600; cursor: pointer;">
                            ← Back to Home
                        </button>
                    </div>
                </div>
